        ...
        try {
            ...
            if ($media) {
                ...
                $comments->each(function ($comment) {
                    ...
                    $processReplies = function ($replies) use (&$processReplies) {
                        $replies->each(function ($reply) use (&$processReplies) {
                            $reply->user_name = $reply->users->name;
                            $reply->user_image = $reply->users->image;
                            unset($reply->users);

...
use App\Repositories\Ctg_Book\CtgBookInterface;
...
class CtgBookRepository implements CtgBookInterface
{
    ...
    public function getAllCategories($request)
    {
        try {
            ...
            //     $datas = Ctg_Book::latest('created_at')->get();
            //     $category = $this->($datas, true, false);
            // } else {
            //     $datas = Ctg_Book::latest('created_at')->paginate($limit);

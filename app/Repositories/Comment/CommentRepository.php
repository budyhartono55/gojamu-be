...
class CommentRepository implements CommentInterface
{
    ...
    //             return $this->success("(CACHE): List Komentar dengan keyword = ($keyword) dalam Kategori ($slug).", $result);
    //         }
    ...
    //             return $this->success("List Keseluruhan Komentar berdasarkan keyword = ($keyword) dalam Kategori ($slug)", $comment);
    //         }
    //         return $this->error("Not Found", "Komentar dengan keyword = ($keyword) dalam Kategori ($slug)tidak ditemukan!", 404);
    //     } catch (\Exception $e) {
    ...
    //             return $this->success("(CACHE): List Keseluruhan Komentar berdasarkan Kategori Komentar dengan slug = ($slug).", $result);
    //         }
    //         $category = CtgComment::where('slug', $slug)->first();
    //         if ($category) {
    //             $comment = Comment::with(['createdBy', 'editedBy', 'ctgComments', 'topics' => function ($query) {
    ...
    //             return $this->success("List Keseluruhan Komentar berdasarkan Kategori Komentar dengan slug = ($slug)", $comment);
    //         } else {
    //             return $this->error("Not Found", "Komentar berdasarkan Kategori Komentar dengan slug = ($slug) tidak ditemukan!", 404);
    //         }
    //     } catch (\Exception $e) {
    //         return $this->error("Internal Server Error", $e->getMessage());
    //     }
